...
export default function Home() {
  ...
  const handleAnswerEventPrevent = (e: React.ClipboardEvent<HTMLTextAreaElement>, action: string) => {
    ...
    toast({
      ...
      description: `${action == 'Copy' ? action : 'Past'}ing is disabled for the answer box.`,
      variant: 'destructive',
      duration: 2000,
    });
  };
